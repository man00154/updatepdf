...
→ [{"id": "op1","type": "cell_lookup","label": "Rows where Rated/Subscribed/Metered = 'Rated/Subscribed/Metered' — Bangalore","filter": {"column": "Rated/Subscribed/Metered",
"operator": "equals","value": "Rated/Subscribed/Metered"},"location": ["bangalore"],"files": null,"sheets": null,"operation": null,"field_hint": null,"canonical_columns": ["Space | Rated/Subscribed/Metered"],
"top_n": null,"group_by_location": false,"customer_name": null,"cell_value": "Rated/Subscribed/Metered","target_column_hint": "Rated/Subscribed/Metered","return_columns": null,"match_mode": "exact"}]
