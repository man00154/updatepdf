...
6. For particular customer query show results of the particular customer only do not display all customers rows. as in last please do not show customer name wise all rows having other customers names also. 
