...
→ [{"id":"op1","type":"cell_lookup","label":"Rated/Subscribed/Metered rows — Bangalore","filter":null,"location":["bangalore"],"files":null,"sheets":null,"operation":null,"field_hint":null,"canonical_columns":["Space | Rated/Subscribed/Metered"],"top_n":null,"group_by_location":false,"customer_name":null,"cell_value":"Rated/Subscribed/Metered","target_column_hint":"rated/subscribed/metered","return_columns":null,"match_mode":"exact"}]
